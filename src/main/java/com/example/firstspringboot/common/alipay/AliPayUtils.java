...
//        runTui();
    ...
    public static void runTui () throws Exception{
        ...
        request.setBizContent("{" +
                "\"out_trade_no\":\"201801374310141074350080\"," +
                "\"trade_no\":\"2019092522001401200515639665\"," +
                "\"refund_amount\":0.01," +
                "\"refund_reason\":\"正常退款\"," +
                "\"out_request_no\":\"AliPay123456\"" +
                "  }");
        AlipayTradeRefundResponse response = alipayClient.execute(request);



        System.out.println("支付宝退款响应："+JSONObject.toJSONString(response));
    ...
    public static void runTuiQuery () throws Exception{
        String APP_PRIVATE_KEY = "";
        String ALIPAY_PUBLIC_KEY = "";
        ...
        request.setBizContent("{" +
                "\"trade_no\":\"201801374310141074350080\"," +
                "\"out_trade_no\":\"2019092522001401200515639665\"," +
                "\"out_request_no\":\"AliPay123456\"" +
                "  }");
        AlipayTradeFastpayRefundQueryResponse response = alipayClient.execute(request);

        System.out.println("支付宝退款查询响应："+JSONObject.toJSONString(response));
        if(response.isSuccess()){
            System.out.println("调用成功");
        } else {
            System.out.println("调用失败");
