 ...
 * @Author :sunwenwu
 * @Date : 2021/1/10
 * @Description :  创建HttpReqHead
 */
public class IpnHttpHeader {

    private IpnHttpHeader() {
    }


    public static IpnHttpHeader custom() {
        return new IpnHttpHeader();
    }
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader other(String key, String value) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader accept(String accept) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader acceptCharset(String acceptCharset) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader acceptEncoding(String acceptEncoding) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader acceptLanguage(String acceptLanguage) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader acceptRanges(String acceptRanges) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader authorization(String authorization) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader cacheControl(String cacheControl) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader connection(String connection) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader cookie(String cookie) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader contentLength(String contentLength) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader contentType(String contentType) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader date(String date) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader expect(String expect) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader from(String from) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader host(String host) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader ifMatch(String ifMatch) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader ifModifiedSince(String ifModifiedSince) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader ifNoneMatch(String ifNoneMatch) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader ifRange(String ifRange) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader ifUnmodifiedSince(String ifUnmodifiedSince) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader maxForwards(String maxForwards) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader pragma(String pragma) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader proxyAuthorization(String proxyAuthorization) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader range(String range) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader referer(String referer) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader te(String te) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader upgrade(String upgrade) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader userAgent(String userAgent) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader warning(String warning) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader via(String via) {
     ...
     * @return 返回当前对象
     */
    public IpnHttpHeader keepAlive(String keepAlive) {
    ...
    public static class HeaderConsts {
        ...
        public static final String APP_FORM_JSON = "application/json;charset=UTF-8";
        public static final String APP_FORM_UPLOAD = "multipart/form-data";
